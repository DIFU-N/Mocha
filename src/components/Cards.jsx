    ...
    <div className='w-full py-[10rem] px-4 bg-white'>
        <div className='max-w-[77.5rem] mx-auto grid md:grid-cols-3 gap-8'>
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                <img className='w-20 h-20 mx-auto mt-[-3rem] bg-white hover:scale-150' src={Marvel} alt="Captain Marvel"/>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300'>
                <img className='w-20 h-20 mx-auto mt-[-3rem] bg-white hover:scale-150' src={Guardians} alt="Guardians of the Galaxy"/>
            ...
            <div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                <img className='w-20 h-20 mx-auto mt-[-3rem] bg-transparent hover:scale-150' src={Loki} alt="Loki"/>
